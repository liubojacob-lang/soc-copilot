...
def success_response(
    data: T = None, message: str = "OK", trace_id: str = None
) -> APIResponse[T]:
    ...
    """
    return APIResponse(code="SUCCESS", message=message, data=data, trace_id=trace_id)


def created_response(
    data: T = None, message: str = "Resource created successfully", trace_id: str = None
) -> APIResponse[T]:
    ...
    """
    return APIResponse(code="CREATED", message=message, data=data, trace_id=trace_id)
...
def paginated_response(
    ...
    return PaginatedResponse(
        code="SUCCESS", message=message, data=paginated_data, trace_id=trace_id
    )
