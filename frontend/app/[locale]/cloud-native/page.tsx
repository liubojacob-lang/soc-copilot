...
import { Cloud, Container, Shield, Server, AlertTriangle, CheckCircle, Scan } from "lucide-react";
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-gray-900 dark:text-white">
                      {dashboard.overview?.total_containers ?? 0}
                    </p>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-orange-600">
                      {dashboard.overview?.vulnerable_images ?? 0}
                    </p>
                  </div>
                    ...
                    <div className="mt-6 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                      ...
                      <p className="text-xs text-gray-500 mt-1">
                        ...
                        {dashboard.compliance?.last_scan
                          ? new Date(dashboard.compliance.last_scan).toLocaleString()
                          : "-"}
                      </p>
                    </div>
                  </div>
