...
def create_composite_indexes():
    ...
    indexes.append(Index("idx_user_role_active", UserModel.role, UserModel.is_active))
    ...
    indexes.append(
        Index("idx_user_active_time", UserModel.is_active, UserModel.created_at.desc())
    )
    ...
    indexes.append(
        Index(
            "idx_alert_severity_time", AlertModel.severity, AlertModel.created_at.desc()
        )
    )
    ...
    indexes.append(
        Index("idx_alert_status_time", AlertModel.status, AlertModel.created_at.desc())
    )
