...
class IOCHitBase(BaseModel):
    ...
    history_id: Optional[str] = Field(None, description="Associated history record ID")
    ...
    context_snippet: Optional[str] = Field(None, description="Context snippet")
...
class IOCHitListRequest(BaseModel):
    ...
    ioc: Optional[str] = Field(None, description="Filter by IOC value")
