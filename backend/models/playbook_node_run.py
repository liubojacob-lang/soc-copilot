...
class PlaybookNodeRunModel(Base):
    ...
    node_id: Mapped[str] = mapped_column(String(100), index=True, nullable=False)  # DAG node id
    ...
    status: Mapped[str] = mapped_column(String(20), index=True, nullable=False, default="pending")  # pending/running/success/failed/skipped/cancelled
    ...
    # Relationships
    attempts = relationship("PlaybookNodeAttemptModel", back_populates="node_run", cascade="all, delete-orphan")
