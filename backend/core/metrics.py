...
def record_playbook_run(playbook_name: str, status: str, mode: str, duration: float, tenant_id: str = "default"):
    observe_playbook_run(playbook_name, status, mode, tenant_id, duration)


def record_playbook_error(playbook_name: str, error_type: str, tenant_id: str = "default"):
    observe_playbook_error(playbook_name, error_type, tenant_id)


def record_ai_request(model: str, provider: str, status: str, duration: float, tokens_input: int = 0, tokens_output: int = 0):
