      ...
      <main className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
                      ...
                      <tbody className="divide-y divide-gray-100 dark:divide-gray-700/60">
                        {containers.map((cnt) => (
                          ...
                          >
                            ...
                            <td className="py-3 px-4">
                              <div
                                className="font-mono text-text-primary text-[11px] max-w-[220px] truncate"
                                title={cnt.image}
                              >
                                {cnt.image}
                              </div>
                            ...
                            >
                              <div className="flex items-center justify-end gap-2">
                                <button
                                  onClick={() => openContainerInspector(cnt.id)}
                                  className="px-2.5 py-1 bg-surface-hover hover:bg-blue-50 text-text-secondary hover:text-blue-600 dark:bg-surface-active dark:hover:bg-gray-600 rounded text-xs font-medium transition-colors flex items-center gap-1"
                                >
              ...
              <div className="px-6 py-3.5 border-t border-border-subtle dark:border-border-strong bg-surface-card/70 dark:bg-surface-card/60 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-text-secondary dark:text-text-muted">
                ...
                <div className="flex items-center gap-1">
                  <button
                    ...
                    className="px-2.5 py-1.5 rounded border border-border-subtle dark:border-gray-600 bg-white dark:bg-surface-active text-text-secondary hover:bg-surface-card dark:hover:bg-gray-600 disabled:opacity-40 disabled:cursor-not-allowed flex items-center gap-1 transition-colors"
                    title={t("prevPage")}
                  >
                        ...
                        <button
                          ...
                          className={`min-w-[28px] h-7 px-2 rounded text-xs font-medium transition-colors ${
                            containerPage === p
                              ...
                              : "bg-white dark:bg-surface-active border border-border-subtle dark:border-gray-600 text-text-secondary hover:bg-surface-card dark:hover:bg-gray-600"
                          }`}
                        >
                          {p}
                        </button>
        ...
        {clusterModalOpen && (
          <div
            ...
            onMouseDown={(e) => {
              if (e.target === e.currentTarget) setClusterModalOpen(false);
            }}
          >
            <div
              className="bg-white dark:bg-surface-card rounded-2xl max-w-5xl w-full max-h-[90vh] flex flex-col shadow-2xl border border-border-subtle dark:border-border-strong overflow-hidden"
            ...
            >
              ...
              <div className="p-6 border-b border-border-subtle dark:border-border-strong flex items-center justify-between bg-surface-card/50 dark:bg-gray-750">
                ...
                <button
                  ...
                  className="p-2 text-text-muted hover:text-text-secondary dark:hover:text-text-primary rounded-lg hover:bg-surface-hover dark:hover:bg-surface-active transition-colors"
                >
                  <X className="w-5 h-5" />
                </button>
              </div>
        ...
        {complianceModalOpen && (
          <div
            className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-in fade-in duration-200"
            onMouseDown={(e) => {
              if (e.target === e.currentTarget) setComplianceModalOpen(false);
            }}
          >
            <div
              className="bg-white dark:bg-surface-card rounded-2xl max-w-4xl w-full max-h-[90vh] flex flex-col shadow-2xl border border-border-subtle dark:border-border-strong overflow-hidden"
              onMouseDown={(e) => e.stopPropagation()}
            >
              <div className="p-6 border-b border-border-subtle dark:border-border-strong flex items-center justify-between bg-surface-card/50 dark:bg-gray-750">
                <div className="flex items-center gap-3">
        ...
        {findingsModalOpen && (
          <div
            className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-in fade-in duration-200"
            onMouseDown={(e) => {
              if (e.target === e.currentTarget) setFindingsModalOpen(false);
            }}
          >
            <div
              className="bg-white dark:bg-surface-card rounded-2xl max-w-4xl w-full max-h-[90vh] flex flex-col shadow-2xl border border-border-subtle dark:border-border-strong overflow-hidden"
        ...
        {cloudModalOpen && (
          <div
            className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-in fade-in duration-200"
            onMouseDown={(e) => {
              if (e.target === e.currentTarget) setCloudModalOpen(false);
            }}
          >
            <div
              className="bg-white dark:bg-surface-card rounded-2xl max-w-3xl w-full max-h-[90vh] flex flex-col shadow-2xl border border-border-subtle dark:border-border-strong overflow-hidden"
              onMouseDown={(e) => e.stopPropagation()}
            >
              <div className="p-6 border-b border-border-subtle dark:border-border-strong flex items-center justify-between bg-surface-card/50 dark:bg-gray-750">
                <div className="flex items-center gap-3">
        ...
        {containerDetailModalOpen && (
          <div
            className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-in fade-in duration-200"
            onMouseDown={(e) => {
              if (e.target === e.currentTarget) setContainerDetailModalOpen(false);
            }}
          >
            <div
              className="bg-white dark:bg-surface-card rounded-2xl max-w-4xl w-full max-h-[90vh] flex flex-col shadow-2xl border border-border-subtle dark:border-border-strong overflow-hidden"
                          ...
                          <div className="bg-surface-card dark:bg-gray-750 border border-border-subtle dark:border-border-strong rounded-xl overflow-hidden divide-y divide-gray-200 dark:divide-gray-700">
                            {Object.entries(selectedContainer.env_vars).map(([k, v]) => (
                              ...
                              >
                                ...
                                <span className="text-text-primary bg-white dark:bg-surface-card px-2 py-0.5 rounded border border-border-subtle dark:border-border-strong">
                                  {v}
                                </span>
                              </div>
                            ))}
