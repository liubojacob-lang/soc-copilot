...
from sqlalchemy import String, JSON, Integer, Float, Boolean, Text, Index
...
class CorrelationRule(Base):
    ...
    min_similarity: Mapped[float] = mapped_column(
        ...
        nullable=False,
        default=0.7,
        doc="Minimum similarity score (0-1)"
    )
    ...
    action_params: Mapped[dict] = mapped_column(
        JSON,
        nullable=True,
        doc="Action-specific parameters"
    )
    ...
    # Statistics
    total_correlations: Mapped[int] = mapped_column(
        Integer,
        nullable=False,
        default=0
    )
