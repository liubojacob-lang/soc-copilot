...
from services.performance_monitor import PerformanceMonitor, PerformanceMetricType
...
async def get_performance_report(
    time_window_minutes: int = Query(60, ge=1, le=1440, description="Time window in minutes (1-1440)"),
...
async def get_api_metrics(
    time_window_minutes: int = Query(30, ge=1, le=1440, description="Time window in minutes (1-1440)"),
    ...
    try:
        ...
        for table_name, row_count in tables:
            table_stats.append({
                ...
                "row_count": row_count,
                "size_category": "large" if row_count > 100000 else "medium" if row_count > 10000 else "small",
            })
