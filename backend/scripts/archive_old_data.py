...
class DataArchiver:
    ...
    async def archive_alerts(self) -> int:
        cutoff_date = datetime.now(UTC) - timedelta(days=self.archive_days_alerts)
    ...
    async def archive_history(self) -> int:
        cutoff_date = datetime.now(UTC) - timedelta(days=self.archive_days_history)
    ...
    async def archive_audit_logs(self) -> int:
        cutoff_date = datetime.now(UTC) - timedelta(days=self.archive_days_audit)
