...
export const getCommonActions = (t: (key: string) => string): FilterOption[] => [
...
export const getExtendedActions = (t: (key: string) => string): FilterOption[] => [
...
/** Common path filters */
export const getCommonPaths = (t: (key: string) => string): FilterOption[] => [
...
export const getExtendedPaths = (t: (key: string) => string): FilterOption[] => [
...
/** Status code filters */
export const getStatusCodes = (t: (key: string) => string): FilterOption[] => [
...
export const getExtendedStatusCodes = (t: (key: string) => string): FilterOption[] => [
