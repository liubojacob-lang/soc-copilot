...
async def main():
    parser = argparse.ArgumentParser(description="Archive old data from SOC Copilot database")
    parser.add_argument("--alerts-days", type=int, default=90, help="Archive alerts older than this many days")
    parser.add_argument("--history-days", type=int, default=30, help="Archive history older than this many days")
    parser.add_argument("--audit-days", type=int, default=180, help="Archive audit logs older than this many days")
    parser.add_argument("--dry-run", action="store_true", help="Show what would be archived without deleting")
