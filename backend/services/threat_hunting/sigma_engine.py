...
class SigmaEngine:
    ...
    def get_categories(self) -> list[str]:
        return sorted({r.category for r in self.rules.values()})
    ...
    def rule_to_sql(rule: dict) -> str:
        ...
        def _selection_replacer(m):
            name = m.group(1)
            return selections.get(name, "1=1")
    ...
    def _resolve_table(self, logsource: dict, category: str) -> str:
        ...
        category_table = {
            ...
            "linux": "linux_audit_log",
            "cloud": "cloud_logs",
            "kubernetes": "k8s_audit_logs",
...
FALLBACK_RULES = [
    ...
    },
    {
        ...
        "detection": {
            "selection": {
                ...
                "CommandLine|contains": ["save", "sam", "system"],
            },
            "condition": "selection",
        },
    ...
    },
    {
        ...
        "detection": {
            ...
            "selection_path": {
                "path|contains": ["/usr/bin/passwd", "/usr/bin/sudo", "/bin/su"]
            },
    ...
    },
    {
        ...
        "detection": {
            "selection": {
                "syscall": 257,
                "path|contains": ["authorized_keys", ".ssh/"],
                "key": "file_access",
            },
            "condition": "selection",
        },
    ...
    },
    {
        ...
        "detection": {
            "selection": {
                ...
                "protoPayload.methodName": ["SetIamPolicy", "SetBucketIamPolicy"],
                "protoPayload.authenticationInfo.principalEmail|contains": "gserviceaccount.com",
            },
            "condition": "selection",
        },
