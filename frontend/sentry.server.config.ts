...
const SENTRY_RELEASE =
  process.env.SENTRY_RELEASE || process.env.NEXT_PUBLIC_SENTRY_RELEASE || "0.8.0";
...
if (SENTRY_DSN) {
  ...
  console.log(
    `[Sentry] Server initialized: environment=${SENTRY_ENVIRONMENT}, release=${SENTRY_RELEASE}`
  );
} else {
