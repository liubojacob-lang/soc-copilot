...
def upgrade() -> None:
    ...
    op.add_column(
        ...
        sa.Column("dify_app_id", sa.String(100), nullable=True, index=True),
    )
    op.add_column(
        "playbook_definitions",
        sa.Column("dify_synced_at", sa.DateTime(timezone=True), nullable=True),
    )
    op.add_column(
        "playbook_definitions",
        sa.Column(
            "execution_engine", sa.String(20), server_default="native", nullable=False
        ),
    )
