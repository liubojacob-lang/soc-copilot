...
export default function TriggersPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <Navigation title="Triggers" subtitle="Manage webhook and cron triggers for automated playbook execution" />
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex justify-between items-center mb-6">
          <div>
            <h2 className="text-xl font-semibold text-gray-900 dark:text-white">Triggers</h2>
            <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
              Automate playbook execution with webhooks and cron schedules
            </p>
          </div>
          ...
          {filteredTriggers.length === 0 ? (
            <div className="p-8 text-center">
              <p className="text-gray-500 dark:text-gray-400">
                {filterType === "all" ? "No triggers found. Create your first trigger to get started." : `No ${filterType} triggers found.`}
              </p>
            </div>
          ) : (
                  ...
                  {filteredTriggers.map((trigger) => (
                    <tr key={trigger.id}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-white">
                        {trigger.name || <span className="text-gray-400 italic">Unnamed</span>}
                      </td>
        ...
        <div className="mt-6 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-md">
          <h3 className="text-sm font-medium text-blue-800 dark:text-blue-300 mb-2">About Triggers</h3>
          <ul className="text-sm text-blue-700 dark:text-blue-400 space-y-1 list-disc list-inside">
            <li><strong>Webhook triggers:</strong> Execute playbooks via HTTP requests with secret authentication</li>
            <li><strong>Cron triggers:</strong> Schedule playbook execution using cron expressions</li>
            <li>All trigger executions are logged in the audit log</li>
          </ul>
        </div>
      </main>
    </div>
