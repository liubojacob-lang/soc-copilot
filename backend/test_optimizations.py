...
def test_config_validation():
    ...
    print(f"✓ Development mode: secret_encryption_key auto-generated: {bool(settings_dev.secret_encryption_key)}")
...
def test_rate_limiter():
    ...
    from middleware.rate_limiter import AsyncRateLimiter, get_rate_limiter
    
    # Test singleton
    limiter = get_rate_limiter()
    print(f"✓ Rate limiter singleton created")
...
def test_performance_middleware():
    ...
    from middleware.performance import PerformanceMiddleware, REQUEST_DURATION_HISTOGRAM
    
    print(f"✓ PerformanceMiddleware class imported")
    print(f"  - Prometheus histogram available: {REQUEST_DURATION_HISTOGRAM is not None}")
...
def test_audit_archive_service():
    ...
    from services.audit_archive_service import AuditArchiveService, get_archive_service
    from db.session import AsyncSessionLocal
    
    # Test service creation
    service = AuditArchiveService(AsyncSessionLocal)
    print(f"✓ AuditArchiveService created")
...
async def test_audit_archive_stats():
    ...
    print(f"✓ Archive stats retrieved")
