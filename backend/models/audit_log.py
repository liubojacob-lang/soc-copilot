...
class AuditLogModel(Base):
    ...
    action: Mapped[str] = mapped_column(String(100), index=True, nullable=False)  # login, playbook_run, user_create, etc.
    ...
    target_type: Mapped[str | None] = mapped_column(String(50), nullable=True)  # user, playbook_run, api_key, etc.
