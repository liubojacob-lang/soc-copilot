...
function StatCard({
  ...
  const colorClasses = {
    ...
    orange: 'bg-orange-50 text-orange-700 dark:bg-orange-900/30 dark:text-orange-300 border-orange-200 dark:border-orange-800',
    ...
    <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-3">
      ...
      <div className="space-y-1.5">
        ...
        <div className="flex items-center justify-between text-xs">
          ...
          <span className="font-semibold text-orange-600 dark:text-orange-400">{data.suspicious}</span>
        </div>
...
function TrendIndicator({ trend }: { trend: 'up' | 'down' | 'stable' }) {
  ...
  const isUp = trend === 'up';
  return (
    <span className={`flex items-center gap-1 text-xs ${isUp ? 'text-red-600 dark:text-red-400' : 'text-green-600 dark:text-green-400'}`}>
      <svg
